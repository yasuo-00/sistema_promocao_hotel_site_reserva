...
class Sidebar extends HTMLElement {
    ...
    renderSidebar(){
        if(sessionStorage.getItem('user')){
            ...
            //renderiza sidebar conforme o tip de usuario
            switch(userType){
                case 'admin':
    ...
    render() {
        //importa os scripts no arquivo html que utilizar o sidebar
        var script = document.createElement('script');
        script.src='/scripts/logout.js';
        document.head.appendChild(script);
        var script2 = document.createElement('script');
        script2.src='/scripts/resizeSidebars.js';
        document.head.appendChild(script2);
        var script3 = document.createElement('script');
        script3.src='/scripts/functionsSidebar.js';
